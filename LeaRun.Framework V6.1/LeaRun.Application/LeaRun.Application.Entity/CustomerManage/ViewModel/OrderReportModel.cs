...
namespace LeaRun.Application.Entity.CustomerManage
{
    ...
    /// 描 述：订单管理
    /// </summary>
    public class OrderReportModel : BaseEntity
    {
        #region 实体成员
        /// <summary>
        /// 订单主键
      ...
      /// <summary>
        ...
        /// <summary>
        /// 报表类型 1：销售代表 2：门店 3：全部
        /// </summary>
        /// <returns></returns>
        public string RptSellerType { get; set; }

        /// <summary>
        /// 报表数据类型 1：销售数据 2：回款数据
        /// </summary>
        /// <returns></returns>
        public string RptDataType { get; set; }

 /// <summary>
        /// 报表数据类型 1：销售 2：回款
        /// </summary>
        /// <returns></returns>
        public string RptAccountType { get; set; }
