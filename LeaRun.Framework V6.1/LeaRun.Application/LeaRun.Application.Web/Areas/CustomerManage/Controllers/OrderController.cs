...
namespace LeaRun.Application.Web.Areas.CustomerManage.Controllers
{
    ...
    public class OrderController : MvcControllerBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult OptionData()
        {
            return View();
        }
        ...
        public ActionResult OptionColor()
        {
            return View();
        }

        public ActionResult OptionStyle()
        {
            return View();
        }
        #endregion
        ...
        /// <returns>返回列表Json</returns>
        [HttpGet]
        public ActionResult GetOrderDescriptionListJson(string orderId)
        {
            var data = orderdescriptionbll.GetList(orderId);
            return ToJsonResult(data);
        }
        ...
        [ValidateAntiForgeryToken]
        [AjaxOnly]
        public ActionResult SaveForm(string keyValue, OrderEntity entity, string orderEntryJson, string orderDescriptionJson)
        {
            UserBLL userBLL = new UserBLL();
            var userent = userBLL.GetEntity(entity.SellerId);
            if(userent==null)
            {
                entity.SellerType = "1";
            }
            ...
            orderBLL.SaveForm(keyValue, entity, orderEntryList, orderDescriptionList);
            return Success("操作成功。");
        }
        #endregion
