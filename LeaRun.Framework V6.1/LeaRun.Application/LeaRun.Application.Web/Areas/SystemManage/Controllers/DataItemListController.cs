...
namespace LeaRun.Application.Web.Areas.SystemManage.Controllers
{
    ...
    public class DataItemListController : MvcControllerBase
    {
        ...
        private Busines.CustomerManage.PriceBLL priceBLL = new Busines.CustomerManage.PriceBLL();
        ...
        [HttpGet]
        public ActionResult GetListJsonCondation(string EnCode, string condition, string keyword)
        {
            var data = dataItemCache.GetDataItemList(EnCode);
            ...
            if (!string.IsNullOrEmpty(keyword))
            {
                ...
                {
                    case "ItemCode":        //项目编号
                        data = data.Where(t => t.ItemCode==(keyword));
