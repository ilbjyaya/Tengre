...
namespace LeaRun.Application.Busines.CustomerManage
{
    ...
    /// 描 述：商机跟进记录
    /// </summary>
    public class Client_ChanceDescriptionBLL
    {
        private IChanceDescriptionService service = new ChanceDescriptionService();
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns>返回列表</returns>
        public IEnumerable<Client_ChanceDescriptionEntity> GetList_(string queryJson)
        {
