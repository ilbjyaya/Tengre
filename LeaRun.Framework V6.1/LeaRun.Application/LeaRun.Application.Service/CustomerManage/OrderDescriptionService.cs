...
namespace LeaRun.Application.Service.CustomerManage
{
    ...
    /// 描 述：商机跟进记录
    /// </summary>
    public class OrderDescriptionService : RepositoryFactory<Client_OrderDescriptionEntity>, IOrderDescriptionService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        /// <returns>返回列表</returns>
        public IEnumerable<Client_OrderDescriptionEntity> GetList_(string keyValue)
        { 
            ...
            strSql.Append(@"SELECT  r.OrderId ,
                            ...
                            FROM    Client_OrderDescription r
