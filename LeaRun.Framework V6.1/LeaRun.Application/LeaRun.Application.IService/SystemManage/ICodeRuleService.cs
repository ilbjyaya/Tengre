...
namespace LeaRun.Application.IService.SystemManage
{
  ...
  string GetBillCodeApi(string userId, string moduleId, string enCode);
        /// <summary>
        /// 占用单据号
        /// </summary>
        /// <param name="userId">用户ID</param>
...
string SetBillCodeApi(string userId, string moduleId, string enCode, IRepository db = null);
