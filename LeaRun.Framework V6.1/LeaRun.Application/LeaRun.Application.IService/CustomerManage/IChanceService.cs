...
namespace LeaRun.Application.IService.CustomerManage
{
    ...
    public interface IChanceService
    {
        ...
        IEnumerable<ChanceEntity> GetList( string queryJson);
        /// <summary>
        /// 获取实体
        /// </summary>
        ...
        /// <returns></returns>
        void SaveForm(string keyValue, ChanceEntity entity,List<Client_ChanceDescriptionEntity> chanceDescriptionEntitys = null);
  void SaveFormApi(string keyValue, ChanceEntity entity, string userid, string username);
        /// <summary>
        /// 商机作废
        /// </summary>
        /// <param name="keyValue">主键值</param>
