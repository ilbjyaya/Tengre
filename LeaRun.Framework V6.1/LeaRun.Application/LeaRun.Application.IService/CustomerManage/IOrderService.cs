...
namespace LeaRun.Application.IService.CustomerManage
{
    ...
    public interface IOrderService
    {
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns>返回分页列表</returns>
        IEnumerable<OrderEntity> GetList(string queryJson);
        ...
        /// <returns></returns>
        void SaveForm(string keyValue, OrderEntity orderEntity, List<OrderEntryEntity> orderEntryList, List<Client_OrderDescriptionEntity> orderDescriptionList);
        /// 保存表单（新增、修改）
        /// </summary>
        /// <param name="keyValue">主键值</param>
        /// <param name="orderEntity">实体对象</param>
        ...
        /// <returns></returns>
        void SaveFormApi(string keyValue, OrderEntity orderEntity, List<OrderEntryEntity> orderEntryList, List<ReceivableEntity> receivableentityList, string userid, string username);
        #endregion
    }
}